<nav x-data="{ open: false }" class="bg-customColor5 dark:bg-customColor border-b border-customColor5 dark:border-gray-700">
    <!-- Primary Navigation Menu -->
    <div class="bg-customColor5 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-customColor4 dark:text-customColor4">
                        {{ __('Home') }}
                    </x-nav-link>
