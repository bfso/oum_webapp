    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <h1> <strong>Schiedsrichterkandidaten </strong></h1><br>
                <p>
                Jede Person kann Schiedsrichter/in werden. Es besteht keine Pflicht einem Verein anzugehören. Es wird jedoch empfohlen, dass man einem Verein angehört um auch aktiv üben zu können. Die Erfahrung ist ein wichtiger Punkt bei der Schiedsrichtertätigkeit. Interessierte Personen können sich unter info@oum.ch mit der OUM in Verbindung setzen </p>
                <br>
                <h1> <strong> Aufwand / Entschädigung</h1> </strong><br>
                <p>Der Aufwand ist abhängig von der Anzahl Schiedsrichter. 2 - 4 Pflichtaufgebote erhält jeder Schiedsrichter pro Saison. Jeder Schiedsrichter erhält pro Spiel mindestens eine Entschädigung von Fr. 25.-- plus Reisespesen (Wohnort - Turnierort; retour 2. Klasse ÖV)</p>
                <br>
                <h1><strong> Kontingent</h1> </strong><br>
                <p>Jeder Verein muss in Abhänigkeit der Anzahl Team ein Schiedsrichterkontingent erfüllen. Ein Schiedsrichter/in die das 18 Altersjahr erreicht haben. </p>
                <br>
                <h1><strong> Verständnis und Mithilfe seitens Unihockey Akteure</h1> </strong><br>
                <p>
